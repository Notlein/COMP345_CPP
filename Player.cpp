...
Player::Player(int reinforcement, string playerName, vector<Territory*> *territories,vector<Player*> *noAttack, HandCards * hand, OrdersList * ol) {
...
Player::Player(const Player &p) {
    ...
    this->hand = new HandCards(*(p.hand));
