...
{
	cout << (" The current vec_deck contains ") << vec_deck.size() << (" cards. \n") << endl;
...
void HandCards::print_vec_hand_cards()
{
	if (vec_hand_cards.size() > 0) {
		cout << (" The Hand cards has ") << vec_hand_cards.size() << (" cards ") << endl;
